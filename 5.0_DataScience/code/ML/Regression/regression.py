...
dataset = pd.read_csv('/home/hadoop/1.0tutorials/hadoop_working/5.0_DataScience/5.MachineLearning/2.Regression/Section4-SimpleLinearRegression/Salary_Data.csv')
