...
# SUMMARY: This code was developed as part of Biomarker Extraction MSH Genetic Testing Results/Immunotherapy Market Growth Project.
# MODULE NAME - mDNA_Biomarker_Module3_NLP
# MODULE 3 OF MDNA PROJECT - The code categorises the medical reports(OCR Text) and extracts values of variables such as Patient details using Regular expressions.
# 
##############################################################################################################################################
#
...
Intprt_cat2_regex1 = r'NO.MUTATION.{1,100}'
...
def get_Patient_Details(all_lines,Attr_Template):
	...
	if Attr_Template[0] == 'Category1':
		...
		SpecimenDate = get_SpecimenDate_pat1(all_lines)
		...
		input_string = get_line_cat1(all_lines)
		test1 = get_test1_cat1(input_string)
		test2 = get_test2_cat1(input_string)
		Result1 = get_result1_cat1(input_string)
		Result2 = get_result2_cat1(input_string)
