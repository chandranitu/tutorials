...
cd /home/hadoop/hadoop/hadoop_working/DataScience/5.MachineLearning/8.DeepLearning/code/Concrete-Crack-Detection

python Train_CD.py --in_dir class1 --iter 1500 --save_folder None
python Running.py --in_dir class1 --meta_file meta --CP_dir copy --save_dir save

python /home/hadoop/hadoop/hadoop_working/DataScience/5.MachineLearning/8.DeepLearning/code/Concrete-Crack-Detection/dataset.py
