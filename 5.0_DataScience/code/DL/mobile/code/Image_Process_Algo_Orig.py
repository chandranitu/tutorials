...
#image = cv2.imread('D:\Third.png')
#Passed Test Cases
image = cv2.imread('D:\project\datascience\mobile\External.png')
#image = cv2.imread('D:\Simp.png')
#image = cv2.imread('D:\Test1.png')
#image = cv2.imread('D:\Test2.png')
#image = cv2.imread('D:\Test3.png')
#image = cv2.imread('D:\Samsung.png')
